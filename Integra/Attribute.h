...
namespace Integra {
	...
	public:
		...
		property String^ DataType
		{
			...
			void set(String^ value)
			{
				...
				//release
				if(value == "ÖÅËÎÅ ×ÈÑËÎ" || value == "INTEGER" || value == "NUMBER")
				{
	...
	public:
		...
		void SetDataType(String^ dataType, int maxLength, int doubleLength)
		{
			...
			if(dataType == "ÑÒÐÎÊÀ" || dataType == "VARCHAR2" || dataType == "ÒÅÊÑÒ" || dataType == "STRING" || dataType == "VARCHAR"  || dataType == "CHAR" || dataType == "SYSTEM.STRING")
			{
				_dataType = "ÑÒÐÎÊÀ";
				MaxLength = maxLength + "";
				return;
			}
			if(dataType == "ÖÅËÎÅ ×ÈÑËÎ" || dataType == "INTEGER" || dataType == "SYSTEM.INT32")
			{
				_dataType = "ÖÅËÎÅ ×ÈÑËÎ";
				if (maxLength == 0)
				{
			...
			if(dataType == "ÄÀÒÀ" || dataType == "DATE" || dataType == "DATETIME" || dataType == "SYSTEM.DATETIME")
			{
				_dataType = "ÄÀÒÀ";
				if (maxLength == 0)
				{
			...
			if(dataType == "×ÈÑËÎ Ñ ÏËÀÂÀÞÙÅÉ ÒÎ×ÊÎÉ"  || dataType == "DECIMAL"  || dataType == "SYSTEM.DECIMAL")
			{
				_dataType = "×ÈÑËÎ Ñ ÏËÀÂÀÞÙÅÉ ÒÎ×ÊÎÉ";
				if (maxLength == 0)
				{
			...
			if(dataType == "ËÎÃÈ×ÅÑÊÈÉ"  || dataType == "BOOL"  || dataType == "BOOLEAN")
			{
				_dataType = "ËÎÃÈ×ÅÑÊÈÉ";
				MaxLength = "";
				return;
